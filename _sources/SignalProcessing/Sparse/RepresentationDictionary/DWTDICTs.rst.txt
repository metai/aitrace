.. _Section-DWTDICTsRepresentationDictionarySparseSignalProcessing:
...
**离散小波变换** (:term:`Discrete Wavelet Transform`, DWT) 将有限长序列信号表示成不同频率的余弦函数之和, 被广泛用于音频与图像的压缩. 目前共有 DCT-I, DCT-II, DCT-III, DCT-IV, DCT-V-VIII 五种变种 [#DCTs]_. DCT在图像压缩上的应用内容参见 [#DCT_larry]_. 最长见的是 DCT-II 型, 下面进行介绍.
