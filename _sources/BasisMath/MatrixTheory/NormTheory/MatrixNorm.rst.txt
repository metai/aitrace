...
.. proof:definition:: Frobenius矩阵范数
   ...
   是 :math:`{\mathbb C}^{m\times n}` 上的矩阵范数, 且与向量范数 :math:`\|\cdot\|_2` 相容. 也称为 **Frobenius 范数** , 或简称 **F-范数** .
...
.. _def-SubordinateNorm:

.. proof:definition:: 从属范数
   ...
   是 :math:`{\mathbb C}^{m\times n}` 上的矩阵范数, 且与向量范数 :math:`\|\cdot\|` 相容. 由上式给出的矩阵范数称为 **由向量导出的矩阵范数** , 简称 **从属范数** (:term:`Subordinate Norm`).
